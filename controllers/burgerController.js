...
module.exports = {
  ...
  findAll: function (req, res) {
    db
      .query("SELECT * FROM burger", function (err, dbTodos) {
        if (err) {
          console.log(err);
          return res
            .status(500)
  ...
  findById: function (req, res) {
    db
      .query("SELECT * FROM burger WHERE id = ?", [req.params.id], function (err, dbTodos) {
        if (err) {
          console.log(err);
          return res
            .status(400)
  ...
  updateTodo: function (req, res) {
    ...
    db
      .query("UPDATE burger SET completed = true WHERE id =?", [req.params.id], function (err, dbTodos) {
        if (err) {
          console.log(err);
          return res
            .status(400)
  ...
  deleteTodo: function (req, res) {
    ...
    db.query("DELETE FROM burger WHERE id = ?", [req.params.id], function (err, dbTodos) {
